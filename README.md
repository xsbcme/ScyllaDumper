...
## [Releases](https://github.com/xsbcme/ScyllaDumper/releases)

预编译版本和发布包可在 GitHub 原生发布页获取。

如果发布页暂时为空，可以先从源码构建；后续版本建议使用 Git tag 创建，例如 `v1.0.0`，再到 GitHub Releases 页面为该 tag 添加说明和附件。
